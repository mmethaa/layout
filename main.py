...
if st.button("📊 พยากรณ์ผลลัพธ์"):
    ...
    if เกรด in grade_high:
        ...
        บ้านเดี่ยว = หลังรวม
        คำเตือน = "🏡 เกรดบ้านสูง: เฉพาะบ้านเดี่ยวเท่านั้น"
    elif เกรด in grade_mid:
        คำเตือน = "🏘️ เกรดบ้านกลาง: พัฒนาแบบผสมตามพฤติกรรมในอดีต"
        ...
        คำเตือน = "🏚️ เกรดบ้านประหยัด: เน้นทาวน์โฮม + บ้านแฝด"
